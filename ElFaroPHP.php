...
<!--FORMULARIO-->
<form id="Formulario" class="OcultarT" action="Conexion_ElFaro" method="POST">
    ...
    <div class="Inputs">
        ...
        <textarea name="Mensaje" id="Mensaje" cols="30" rows="5" placeholder="Mensaje" required></textarea>
        <!--BOTÓN ENVIAR-->
